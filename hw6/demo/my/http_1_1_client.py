...
class HTTPClient:
    ...
    def get(self, url, headers=None, stream=False):
        ...
        if self.client_socket == None:
            ...
            self.client_socket.settimeout(5)  # Set a timeout for socket operations
...
class Response:
    ...
    def recv_header(self):
        ...
        if self.version != "HTTP/1.1" or self.status != "200 OK" or "content-length" not in self.headers:
            return 1
